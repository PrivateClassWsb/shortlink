...
import com.wsb.shortlink.project.common.convention.exception.ClientException;
import com.wsb.shortlink.project.common.convention.exception.ServiceException;
import com.wsb.shortlink.project.common.enums.ValidDateTypeEnum;
...
import com.wsb.shortlink.project.dao.entity.ShortLinkGotoDO;
import com.wsb.shortlink.project.dao.mapper.LinkAccessStatsMapper;
import com.wsb.shortlink.project.dao.mapper.LinkLocaleStatsMapper;
import com.wsb.shortlink.project.dao.mapper.ShortLinkGotoMapper;
...
import com.wsb.shortlink.project.dto.req.ShortLinkUpdateReqDTO;
...
import static com.wsb.shortlink.project.common.constant.RedisKeyConstant.*;
import static com.wsb.shortlink.project.common.constant.ShortLinkConstant.AMAP_REMOTE_URL;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    private void shortLinkStats(String fullShortUrl, String gid, ServletRequest request, ServletResponse response){
        ...
        try {
            Runnable addResponseCookiesTask = () -> {
            ...
            if (ArrayUtil.isNotEmpty(cookies)) {
                Arrays.stream(cookies)
                        ...
                        }, addResponseCookiesTask);
            }else {
                addResponseCookiesTask.run();
            }
            ...
            if (StrUtil.isNotBlank(infoCode) && StrUtil.equals(infoCode ,"10000")){
                ...
                LinkLocaleStatsDO linkLocaleStatsDO = LinkLocaleStatsDO.builder()
                        ...
                        .city(unkownFlag ? "未知" : localResultObj.getString("city"))
                        .adcode(unkownFlag ? "未知" : localResultObj.getString("adcode"))
                        .cnt(1)
                        .fullShortUrl(fullShortUrl)
                        .country("中国")
                        .gid(gid)
