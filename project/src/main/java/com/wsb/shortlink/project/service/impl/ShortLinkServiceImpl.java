...
import com.wsb.shortlink.project.config.GotoDomainWhiteListConfiguration;
import com.wsb.shortlink.project.dao.entity.*;
import com.wsb.shortlink.project.dao.mapper.*;
import com.wsb.shortlink.project.dto.biz.ShortLinkStatsRecordDTO;
import com.wsb.shortlink.project.dto.req.ShortLinkBatchCreateReqDTO;
...
import com.wsb.shortlink.project.dto.resp.*;
import com.wsb.shortlink.project.mq.producer.DelayShortLinkStatsProducer;
import com.wsb.shortlink.project.mq.producer.ShortLinkStatsSaveProducer;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (!Objects.equals(hasShortLinkDO.getValidDateType(), requestParam.getValidDateType())
            ...
            // 将短链接从缓存中删除，当再次访问时让他重新去查数据库
            stringRedisTemplate.delete(String.format(GOTO_SHORT_LINK_KEY, requestParam.getFullShortUrl()));
            // 如果当前短链接是过期状态
            if (hasShortLinkDO.getValidDate() != null && hasShortLinkDO.getValidDate().before(new Date())) {
                // 而要将短链接修改为永久或有效时，将他从空值跳转缓存中删除
